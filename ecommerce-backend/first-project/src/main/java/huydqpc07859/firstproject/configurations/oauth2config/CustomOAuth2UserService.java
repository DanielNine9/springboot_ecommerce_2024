...
import huydqpc07859.firstproject.model.user.oauth2.OAuth2UserInfo;
import huydqpc07859.firstproject.model.user.oauth2.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest oAuth2UserRequest) throws OAuth2AuthenticationException {
        System.out.println("loadUser in CustomOAuth2UserService");
